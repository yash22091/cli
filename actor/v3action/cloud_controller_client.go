...
type CloudControllerClient interface {
	...
	GetServiceInstanceByName(serviceInstanceName string) (ccv3.ServiceInstance, ccv3.Warnings, error)
	GetSpaceByName(spaceName string) (ccv3.Space, ccv3.Warnings, error)
